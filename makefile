...
TARGET = bin/select_client bin/select_server \
		lib/libsw_tcp_socket_utils.a \
		bin/sw_tcp_socket_server bin/sw_tcp_socket_client \
		bin/datetime_tcp_server bin/datetime_tcp_client \
		bin/echo_tcp_server bin/echo_tcp_client \
		bin/epoll_tcp_server
...
bin/epoll_tcp_server : src/epoll_tcp_server.o
	$(CXX) $^ -o $@
	
src/epoll_tcp_server.o : src/epoll_tcp_server.cpp
	$(CXX) $(CC_OPTS) -c $^ -o $@
